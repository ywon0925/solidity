...
Important Bugfixes:
 * ABI Encoding: When ABI-encoding values in calldata that contain nested arrays, correctly validate the nested array length against ``calldatasize()`` in all cases.
