...
//         let _1 := 0x44
//         let challenge := mod(calldataload(_1), 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001)
...
//         {
//             calldatacopy(add(0x300, shl(7, i)), add(add(calldataload(0x04), mul(i, 0xc0)), 100), 0x80)
//         }
//         let _3 := shl(7, n)
//         let _4 := 0x300
//         mstore(0, keccak256(_4, _3))
//         let b := add(_4, _3)
//         let i_1 := 0
//         for { } lt(i_1, n) { i_1 := add(i_1, 0x01) }
//         {
//             let _5 := add(calldataload(0x04), mul(i_1, 0xc0))
//             let k := 0
//             let a := calldataload(add(_5, _1))
//             let c := challenge
//             let _6 := 0x01
//             let _7 := add(i_1, _6)
//             switch eq(_7, n)
...
//             }
//             case 0 {
//                 k := calldataload(add(_5, 0x24))
//             }
//             let gammaX := calldataload(add(_5, 100))
//             let gammaY := calldataload(add(_5, 132))
//             let sigmaX := calldataload(add(_5, 164))
//             let sigmaY := calldataload(add(_5, 196))
//             let _8 := 3
//             if iszero(and(and(and(eq(mod(a, 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001), a), gt(a, _6)), and(eq(mod(k, 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001), k), gt(k, _6))), and(eq(addmod(mulmod(mulmod(sigmaX, sigmaX, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), sigmaX, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), _8, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), mulmod(sigmaY, sigmaY, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47)), eq(addmod(mulmod(mulmod(gammaX, gammaX, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), gammaX, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), _8, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47), mulmod(gammaY, gammaY, 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47)))))
//             {
//                 mstore(0, 400)
//                 revert(0, 0x20)
//             }
//             switch gt(_7, calldataload(0x24))
//             case 1 {
...
//             }
//             calldatacopy(0xe0, add(_5, 164), 0x40)
//             calldatacopy(0x20, add(_5, 100), 0x40)
...
//                 mstore(0x200, sub(0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47, mload(0x100)))
//             }
//             if gt(i_1, calldataload(0x24))
//             {
//                 mstore(0x60, c)
//                 let _9 := 0x220
//                 let result_4 := and(result, call(gas(), 7, 0, 0x20, 0x60, _9, 0x40))
//                 let result_5 := and(result_4, call(gas(), 6, 0, _9, 0x80, 0x260, 0x40))
...
//             b := add(b, 0x40)
//         }
//         if lt(calldataload(0x24), n)
//         {
//             let t2_x := calldataload(100)
//             let t2_x_1 := calldataload(132)
//             let t2_y := calldataload(164)
//             let t2_y_1 := calldataload(196)
//             let _10 := 0x90689d0585ff075ec9e99ad690c3395bc4b313370b38ef355acdadcd122975b
//             let _11 := 0x12c85ea5db8c6deb4aab71808dcb408fe3d1e7690c43d37b4ce6cc0166fa7daa
//             let _12 := 0x198e9393920d483a7260bfb731fb5d25f1aa493335a9e71297e485b7aef312c2
//             let _13 := 0x1800deef121f1e76426a00665e5c4479674322d4f75edadd46debd5cd992f6ed
//             if or(or(or(or(or(or(or(iszero(t2_x), iszero(t2_x_1)), iszero(t2_y)), iszero(t2_y_1)), eq(t2_x, _13)), eq(t2_x_1, _12)), eq(t2_y, _11)), eq(t2_y_1, _10))
//             {
//                 mstore(0, 400)
//                 revert(0, 0x20)
//             }
...
//             mstore(_16, t2_y)
//             mstore(0x160, t2_y_1)
//             let success := call(gas(), 8, 0, _15, _16, _15, _15)
//             if or(iszero(success), iszero(mload(_15)))
//             {
//                 mstore(0, 400)
//                 revert(0, _15)
//             }
//         }
//         if iszero(eq(mod(keccak256(_2, add(b, not(671))), 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001), challenge))
//         {
//             mstore(0, 404)
//             revert(0, 0x20)
//         }
